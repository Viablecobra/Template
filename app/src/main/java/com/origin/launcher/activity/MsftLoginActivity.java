...
public class MsftLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        codeVerifier = com.origin.launcher.utils.CryptoUtils.generateCodeVerifier();
        state = com.origin.launcher.utils.CryptoUtils.randomString(32);

        String url = MsftAuthManager.buildAuthorizeUrl(CLIENT_ID, SCOPE, com.origin.launcher.utils.CryptoUtils.urlSafeBase64(com.origin.launcher.utils.CryptoUtils.sha256(codeVerifier)), state);
        webView.loadUrl(url);
    }
