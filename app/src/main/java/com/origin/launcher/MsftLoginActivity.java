...
public class MsftLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        codeVerifier = com.origin.launcher.CryptoUtils.generateCodeVerifier();
        state = com.origin.launcher.CryptoUtils.randomString(32);

        String url = MsftAuthManager.buildAuthorizeUrl(CLIENT_ID, SCOPE, com.origin.launcher.CryptoUtils.urlSafeBase64(com.origin.launcher.CryptoUtils.sha256(codeVerifier)), state);
        webView.loadUrl(url);
    }
